...
public class StuRecordAdapter extends ArrayAdapter {
    public StuRecordAdapter(@NonNull Context context, int resource, @NonNull ArrayList<StuGetRecord> list) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if(itemView == null){
            itemView = LayoutInflater.from(getContext()).inflate(R.layout.list_item_stu,
                    parent,
                    false);
        }
